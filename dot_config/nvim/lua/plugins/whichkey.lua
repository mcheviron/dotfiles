return {
  {
    ...
    config = function()
      ...
      local mappings = {
        ...
        g = {
          name = "Golang",
          e = { ':GoIfErr<cr>', "GoIfErr" },
          m = { function()
            local cmd = vim.fn.input("Command: ")
            vim.api.nvim_command("GoMod " .. cmd)
          end, "go mod" },
          g = { function()
          ...
          t = {
            ...
            a = { function()
              ...
              vim.api.nvim_command("GoTagAdd " .. tag)
            end, "GoTagAdd" },
            r = { function()
              local tag = vim.fn.input("Tag: ")
              vim.api.nvim_command("GoTagRm " .. tag)
            end, "GoTagRm" }
          },
          T = {
            name = "Test",
            t = { ":GoTestAdd<cr>", "Test function" },
            T = { ":GoTestsAll<cr>", "Test all functions" },
            E = { ":GoTestsExp<cr>", "Test all exported functions" },
          },
        },
      }
